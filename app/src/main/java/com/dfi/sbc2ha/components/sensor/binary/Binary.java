...
import static com.dfi.sbc2ha.services.state.sensor.BinaryState.PRESSED;
import static com.dfi.sbc2ha.services.state.sensor.BinaryState.RELEASED;
...
public class Binary extends BinarySensor {
    ...
    public void handleFakeState(BinaryState state) {
        switch (state) {
            case PRESSED:
                handlePressed(-1);
                break;
