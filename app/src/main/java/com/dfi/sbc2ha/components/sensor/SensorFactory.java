...
import com.dfi.sbc2ha.components.platform.bus.Lm75Bus;
import com.dfi.sbc2ha.components.platform.bus.ModbusBus;
import com.dfi.sbc2ha.components.platform.bus.OWireBus;
import com.dfi.sbc2ha.components.sensor.analog.AnalogSensor;
import com.dfi.sbc2ha.components.sensor.analog.NtcSensor;
import com.dfi.sbc2ha.components.sensor.analog.ResistanceSensor;
import com.dfi.sbc2ha.components.sensor.binary.Binary;
import com.dfi.sbc2ha.components.sensor.binary.Button;
import com.dfi.sbc2ha.components.sensor.temperature.Lm75TempSensor;
import com.dfi.sbc2ha.components.sensor.temperature.oneWire.OneWireFactory;
import com.dfi.sbc2ha.components.sensor.temperature.oneWire.W1TempSensor;
...
import com.dfi.sbc2ha.util.ConfigurePin;
import com.dfi.sbc2ha.util.UnitConverter;
