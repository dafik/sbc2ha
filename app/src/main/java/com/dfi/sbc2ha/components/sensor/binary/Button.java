package com.dfi.sbc2ha.components.sensor.binary;

import com.dfi.sbc2ha.components.sensor.BinarySensor;
import com.dfi.sbc2ha.components.sensor.binary.click.detector.ClickDetector;
import com.dfi.sbc2ha.components.sensor.binary.click.detector.ClickDetectorFactory;
...
import static com.dfi.sbc2ha.services.state.sensor.ButtonState.*;
...
public class Button extends BinarySensor {
    ...
    public void handleFakeState(ButtonState state) {
        switch (state) {
            case SINGLE:
                handleCLick(-1);
                break;
