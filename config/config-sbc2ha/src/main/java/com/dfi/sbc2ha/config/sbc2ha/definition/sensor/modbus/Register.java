...
import com.dfi.sbc2ha.config.sbc2ha.definition.enums.ModbusReturnType;
...
public class Register {
    ...
    SensorDeviceClassType deviceClass;
    ...
    @JsonIgnore
    public float decode(short[] responseData, int base) {
        switch (returnType) {
            case FLOAT32:
    ...
    private float regular_result(short[] result, int base) {
