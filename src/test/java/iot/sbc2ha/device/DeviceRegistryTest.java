...
class DeviceRegistryTest {
    ...
    void acceptsUniqueDevices() {
        ...
        reg.add(new ButtonDevice("btn_1", "Btn 1", null));
    ...
    void rejectsDuplicateId() {
        DeviceRegistry reg = new DeviceRegistry();
        reg.add(new ButtonDevice("btn_1", "Btn 1", null));
        reg.add(new ButtonDevice("btn_1", "Btn 2", null));
    ...
    void acceptsValidClickActionTarget() {
        ...
        reg.add(new ButtonDevice("btn_entrance", "Entrance", "light_kitchen"));
        assertDoesNotThrow(reg::validate);
    }
    ...
    void rejectsUnknownClickActionTarget() {
        DeviceRegistry reg = new DeviceRegistry();
        reg.add(new ButtonDevice("btn_entrance", "Entrance", "light_missing"));
        ValidationException ex = assertThrows(ValidationException.class, reg::validate);
    ...
    void acceptsNullClickAction() {
        DeviceRegistry reg = new DeviceRegistry();
        reg.add(new ButtonDevice("btn_free", "Free button", null));
        assertDoesNotThrow(reg::validate);
    }
    ...
    void acceptsEmptyClickAction() {
        DeviceRegistry reg = new DeviceRegistry();
        reg.add(new ButtonDevice("btn_free", "Free button", ""));
        assertDoesNotThrow(reg::validate);
    }

    @Test
    void buttons_returnsOnlyButtons() {
        DeviceRegistry reg = new DeviceRegistry();
        reg.add(new ButtonDevice("btn_1", "B1", null));
        reg.add(new LightDevice("light_1", "L1"));
        reg.add(new ButtonDevice("btn_2", "B2", "light_1"));
        assertEquals(2, reg.buttons().size());
    }
